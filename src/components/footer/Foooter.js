      ...
      <div id="footer">
        <div class="row p-4" style={{ backgroundColor: "white", height:"auto" }}>
          <div className="col-lg-4 col-md-6 col-sm-6 col-12" style={{ fontSize: "15px",marginBottom:"2rem"  }}>
            <a href="/" title="Erzincan Bercislina Güzellik Merkezi" alt="Erzincan Bercislina Güzellik Merkezi">
              <img
                src={MainLogo2}
                alt="logo"
            ...
            >
              {" "}
              Erzincan Bercislina Güzellik Merkezi olarak hastalarımıza ve danışanlarımıza farklı medikal alanlarda hizmet sunmaktayız. Medikal estetikten saç ekimine kadar, son teknoloji cihazlarımız ve uzman ekibimizle her adımda yanınızdayız.

Erzincan Bercislina Güzellik Merkezi olarak, hastalarımıza ulaşmak istedikleri görünümü kazandırmak için farklı tedavi seçenekleri sunuyoruz. 
            </p>
          </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 col-12" style={{ fontSize: "15px",marginBottom:"2rem"  }}>
            <p style={{ color: "#e30387", fontWeight: "bold", fontSize: "18px" }}>
              Erzincan Bercislina Güzellik Merkezi
            </p>
            <hr/>
            <a
