        ...
        <OwlCarousel className="owl-theme owl-roof" {...options}>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o4} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o3} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o1} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o5} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o6} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Güzellik Merkezi"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o2} className="owlCarouselImage" alt="Erzincan Güzellik Merkezi" loading="lazy" title="Erzincan Güzellik Merkezi"></img>
