...
import RobotX from "./robotx.webp";
import Magic from "./magicSlim.webp";

export default function Urunler() {
  useDocumentTitle("Erzincan Güzellik Merkezi - Lazer Epilasyon");
  return (
              ...
              >
                <div class="accordion-body">
                  <div>
                    ...
                    <br />
                    <p class="urunyazi">
                      RobotX yüksek soğutma kapasitesi sayesinde diğer soğuk
                      hava üflemeli cihazlardan iki katı daha fazla soğuk hava
                    ...
                    <p class="urunyazi">
                      ...
                      ulaşsalar dahi ciltte yanıklara neden olurlar. Fakat
                      RobotX Hybrid Alexandrite lazer cihazı minimum acı ve
                      maksimum enerjiyle cilde zarar vermeden kıl kökünü etkisiz
                      hale getirir.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p class="urunyazi">
                      RobotXUltra Otomatik Kararan Gözlük, atış sırasında
                      otomatik karararak konforlu bir uygulama sağlar
                      RobotXUltra Otomatik Kararan Gözlük, tüm RobotXUltra
                      cihazlarıyla birlikte ücretsiz olarak verilir. Koruma
                      Özellikleri: Çok yönlü absorpsiyon. Basit tasarım, etkili
                      koruma boyutu Yüksek kaliteli malzeme, güçlü darbe
                      direnci, koruyucu etkisi ile üretilmiştir dikkat çekicidir
                      Ayarlanabilir kol uzunluğu, en iyi aşınma pozisyonunu
                      kolayca bulmanızı sağlayabilir Özellikle lazer koruma
                      tasarımı için, gözlerinize lazer hasarını etkili bir
                      şekilde engelleyebilirsiniz.
                    </p>
                  </div>
